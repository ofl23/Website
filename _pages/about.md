...
I am a member of the [SXS Collaboration](https://www.black-holes.org/), the [LISA Consortium](https://www.lisamission.org/), the [M2SF Collaboration](https://www.self-force.org/), and a former member of the [LIGO Scientific Collaboration](https://www.ligo.org/). Additionally, I am a contributor to the [Spectral Einstein Code](https://www.black-holes.org/code/SpEC.html) (SpEC), and the [KerrGeodesics](https://bhptoolkit.org/KerrGeodesics/) package of the [Black Hole Perturbation Toolkit](https://bhptoolkit.org/).

I earned my MPhys in Physics from The University of Manchester in 2018 and then I completed my PhD in Mathematical Sciences at the University of Southampton in 2022 under the supervision of Prof. Leor Barack. My thesis, titled “<i>[Self-force for hyperbolic black hole encounters](https://eprints.soton.ac.uk/457451/)</i>,” was funded by the Engineering and Physical Sciences Research Council (EPSRC). Following the PhD, I stayed in Southampton for a short postdoctoral position before moving to the [Max Planck Institute for Gravitational Physics (Albert Einstein Institute)](https://www.aei.mpg.de/) in Potsdam, Germany in 2022, and then to University College Dublin in 2026.
